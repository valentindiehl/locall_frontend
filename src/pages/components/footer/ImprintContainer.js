            ...
            <div className="Fade">
                <Container className="imprintContainer">
                    ...
                    <Container className="imprintTextContainer">
                        <p>Angaben gemäß § 5 TMG</p><p>Valentin Diehl <br />
                            Frühlingstraße 29<br />
                            82110 Germering <br />
                        </p><p><strong>Vertreten durch: </strong><br />
                            Valentin Diehl<br />
                        </p><p><strong>Kontakt:</strong> <br />
                            Telefon: 0176-44242605<br />
                            E-Mail: <a href='mailto:hello@valentindiehl.de'>hello@valentindiehl.de</a><br /></p><p>
                            ...
                            href="https://www.kanzlei-hasselbach.de/">Kanzlei Hasselbach, Rechtsanwälte für Arbeitsrecht
                            und Familienrecht</a>
                    </Container>
                </Container>
            </div>
