            ...
            <Container className="toggleContainer">
                <Row>
                    <Col className={this.props.isUser ? "userCol selected" : "userCol"} onClick={this.props.handler}>
                        <img
                            src={this.props.isUser ? "/assets/icons/icons-kunden-white.svg" : "/assets/icons/icons-kunden-gelb.svg"}
                            alt={"User-Icon"}/>
                        <p id="userText">LOKALE GASTRONOMEN UNTERSTÜTZEN</p>
                    </Col>
                    <Col className={!this.props.isUser ? "gastroCol selected" : "gastroCol"}
                         onClick={this.props.handler}>
                        <img
                            src={!this.props.isUser ? "/assets/icons/icons-laden-white.svg" : "/assets/icons/icons-laden-orange.svg"}
                            alt={"Home-Icon"}/>
